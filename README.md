# AutoFill Pro - by Refora Technologies

**Universal smart form autofill. Works on any website. Secure, offline, and fully customizable.**
...
**Please Note:** Openly viewable does **not** mean open source. 
- You may **read** and **review** the code solely to verify its security and integrity.
- You **may not** copy, modify, distribute, publish, merge, or use this code (or any portion of it) for your own projects, whether commercial or non-commercial.
...
1. **Keep the Folder Safe:** Place this extension folder in a permanent location on your hard drive where it will not be accidentally deleted or moved.
2. **Open Extensions Page:** Open your browser and navigate to `chrome://extensions/` (or click the puzzle icon in the toolbar and select "Manage Extensions").
3. **Enable Developer Mode:** Toggle on the **"Developer mode"** switch located in the top right corner of the Extensions page.
4. **Load the Extension:** Click on the **"Load unpacked"** button that appears in the top left corner.
...
---
© 2026 **Refora Technologies**. All rights reserved.
